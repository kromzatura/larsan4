...
// Query: *[_type == "category" && slug.current == $slug][0]{  _id,  _type,  title,  slug,  description,  "meta": {    "title": coalesce(seo.title, title),    "description": seo.metaDescription,    "noindex": coalesce(seo.noindex, false),    "image": seo.image{ asset->{ _id, url, mimeType, metadata{ lqip, dimensions{ width, height } } } }  }}
...
// Query: *[  _type == "post" && references(*[_type == "category" && slug.current == $slug]._id)] | order(coalesce(publishedAt, _createdAt) desc)[$offset...$end]{  _id,  _createdAt,  title,  slug,  excerpt,  author->{    name,    title,    image{ asset->{ _id, url } }  },  categories[]->{ _id, title, slug },}
...
// Query: *[  _type == "post" && references(*[_type == "category" && slug.current == $slug]._id)] | order(title asc)[$offset...$end]{  _id,  _createdAt,  title,  slug,  excerpt,  author->{    name,    title,    image{ asset->{ _id, url } }  },  categories[]->{ _id, title, slug },}
...
// Query: *[  _type == "post" && references(*[_type == "category" && slug.current == $slug]._id)] | order(title desc)[$offset...$end]{  _id,  _createdAt,  title,  slug,  excerpt,  author->{    name,    title,    image{ asset->{ _id, url } }  },  categories[]->{ _id, title, slug },}
...
// Query: count(*[  _type == "post" && references(*[_type == "category" && slug.current == $slug]._id)])
...
// Query: *[_type == "contact"][0]{  tagline,  title,  description,  contactMethods[]{    icon,    title,    description,    link {          _key,    ...,    "href": select(      isExternal => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "product" => "/products/" + @.internalLink->slug.current,      @.internalLink->_type == "productCategory" => "/products/category/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )    }  },    meta{    title,    description,    noindex,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    }  },}
...
// Query: *[_type == "navigation"]{    _type,    _key,    title,    links[]{          _key,    ...,    "href": select(      isExternal => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "product" => "/products/" + @.internalLink->slug.current,      @.internalLink->_type == "productCategory" => "/products/category/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    ),      _type == "link-group" => {        links[]{              _key,    ...,    "href": select(      isExternal => href,      @.internalLink->slug.current == "index" => "/",      @.internalLink->_type == "post" => "/blog/" + @.internalLink->slug.current,      @.internalLink->_type == "product" => "/products/" + @.internalLink->slug.current,      @.internalLink->_type == "productCategory" => "/products/category/" + @.internalLink->slug.current,      "/" + @.internalLink->slug.current    )        }      }    }  }
  ...
  blocks: Array<{
    ...
    columns: Array<{
      ...
      product: {
        _id: string;
        title: string | null;
        specifications: Array<null> | null;
      } | null;
      overrides: {
        name: string | null;
        sku: string | null;
...
// Query: *[_type == "post" && defined(slug)] | order(coalesce(publishedAt, _createdAt) desc)[$offset...$end]{    _id,    _createdAt,    title,    slug,    excerpt,    author->{      name,      title,      image {          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      }    },    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    categories[]->{      _id,      title,      slug,    },}
...
// Query: *[_type == "post" && defined(slug)] | order(title asc)[$offset...$end]{    _id,    _createdAt,    title,    slug,    excerpt,    author->{      name,      title,      image {          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      }    },    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    categories[]->{      _id,      title,      slug,    },}
...
// Query: *[_type == "post" && defined(slug)] | order(title desc)[$offset...$end]{    _id,    _createdAt,    title,    slug,    excerpt,    author->{      name,      title,      image {          ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }      }    },    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    },    categories[]->{      _id,      title,      slug,    },}
...
// Query: count(*[_type == "post" && defined(slug)])
...
// Query: count(*[_type == "product" && defined(slug)])
export type PRODUCTS_COUNT_QUERYResult = number;
// Variable: PRODUCT_CATEGORIES_QUERY
// Query: *[_type == "productCategory" && defined(slug)] | order(orderRank){  _id,  title,  slug}
...
// Query: *[_type == "productCategory" && slug.current == $slug][0]{  _id,  _type,  title,  slug,  description,    meta{    title,    description,    noindex,    image{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    }  }}
...
// Query: count(*[_type == "product" && references(*[_type == "productCategory" && slug.current == $slug]._id)])
