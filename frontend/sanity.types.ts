...
// Query: *[_type == "navigation"]{    _type,    _key,    title,    links[]{        _key,  _type,  title,  buttonVariant,  target,  isExternal,  // Only expose href when marked external  "href": select(isExternal == true => href),  "internalType": internalLink->_type,  "internalSlug": internalLink->slug.current,  iconVariant,  description      , _type == "link-group" => {        links[]{   _key,  _type,  title,  buttonVariant,  target,  isExternal,  // Only expose href when marked external  "href": select(isExternal == true => href),  "internalType": internalLink->_type,  "internalSlug": internalLink->slug.current,  iconVariant,  description }      }    }  }
