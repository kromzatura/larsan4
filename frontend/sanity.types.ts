...
// Query: *[_type == "category" && slug.current == $slug][0]{  _id,  title,  slug,  description,  color,  seo}
...
// Query: *[_type == "post" && defined(slug) && references(*[_type == "category" && slug.current == $slug]._id)] | order(_createdAt desc)[$offset...$end]{  _id,  _createdAt,  title,  slug,  excerpt,  author->{    name,    title,    image{   ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  } }  },  image{   ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  } },  categories[]->{ _id, title }}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"post\" && defined(slug) && references(*[_type == \"category\" && slug.current == $slug]._id)] | order(_createdAt desc)[$offset...$end]{\n  _id,\n  _createdAt,\n  title,\n  slug,\n  excerpt,\n  author->{\n    name,\n    title,\n    image{ \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n }\n  },\n  image{ \n  ...,\n  asset->{\n    _id,\n    url,\n    mimeType,\n    metadata {\n      lqip,\n      dimensions {\n        width,\n        height\n      }\n    }\n  }\n },\n  categories[]->{ _id, title }\n}": POSTS_BY_CATEGORY_QUERYResult;
    "count(*[_type == \"post\" && references(*[_type == \"category\" && slug.current == $slug]._id)])": POSTS_BY_CATEGORY_COUNT_QUERYResult;
