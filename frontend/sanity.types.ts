...
// Query: *[_type == "navigation"]{    _id,    _type,    title,    links[]{      _key,      _type,      title,      buttonVariant,      target,      isExternal,      "href": select(isExternal == true => href),      iconVariant,      description,      // Normalized internal link object (optional)      "internal": select(defined(internalLink) => {        "_type": internalLink->_type,        "slug": internalLink->slug.current      })    }  }
export type NAVIGATION_QUERYResult = Array<{
  ...
  links: Array<{
    ...
    description: null;
    internal: {
      _type: "category" | "contact" | "page" | "post" | "product" | "productCategory" | null;
      slug: string | null;
    };
  }> | null;
}>;
